...
public class Md2 {
    ...
    /**
     * list các ??nh ?ã ???c tính toán l?i các ??nh này m?i ???c dùng ?? v?
     */
    ...
    public void LoadSkin(String filename) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Các hàm c?n ??n GLAutoDrawable thì ph?i ???c g?i trong thread chính!");
        }
    }
